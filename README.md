...
<h4 align="center">The skills I gained from the training I received are as follows:<br>ASP.NET • ASP.NET MVC • ASP.NET Web API • .NET Core • Entity Framework • <br>.NET Core • SOLID Design Principles • JavaScript • React • CSS • HTML5 • <br>RabbitMQ • Microsoft SQL Server • Azure • DevOps.</h4>
